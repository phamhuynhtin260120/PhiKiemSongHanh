...
> Game casual hành động–giải đố theo màn, nơi người chơi điều khiển **hai kiếm khách** bay qua một thế giới Đông Á huyền huyễn trên mây, chuyển đổi giữa hai nhân vật để xử lý đúng loại chướng ngại, thu thập linh khí và đánh bại boss.
...
Trong vương quốc **Thiên Vân Quốc** trên mây, **Lưỡng Nghi Ngọc** bị vỡ khiến linh khí rò rỉ, phong ấn mất kiểm soát và thần thú trở nên hung dữ. Hai kiếm khách **Ren** và **Aiko** lên đường truy tìm các mảnh ngọc để khôi phục cân bằng cho vùng đất.
...
| | **Ren — Kiếm khách Dương** | **Aiko — Pháp kiếm sư Âm** |
|---|---|---|
...
- **Chạm chân dung:** chuyển Ren ↔ Aiko.
- **Chạm kỹ năng:** dash / năng lực nhân vật.
- **Tự động:** tiến về phía trước, thu thập khi chạm và tấn công mục tiêu hợp lệ.

**Health & Failure:** Bắt đầu với **3 tim**. Va chạm hoặc chọn sai nhân vật → mất 1 tim + mất combo + bất tử ngắn. Hết tim → thất bại.
...
- **Audio:** nhạc cụ dây, sáo, percussion nhẹ kết hợp âm fantasy hiện đại; Ren = hit sắc/trầm, Aiko = chuông/gió/âm ngân.
...
**Mục tiêu:** Kiểm chứng rằng *bay → đọc obstacle → chuyển đổi Ren/Aiko* tạo thành trải nghiệm vui trong một level 90 giây.
...
- Ren & Aiko có phải tên chính thức không.
